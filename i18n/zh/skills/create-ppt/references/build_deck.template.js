// ============================================================
// build_deck.template.js — /create-ppt 的 pptxgenjs 脚手架
// 复制到 deck 目录，替换 palette/内容，然后 `node build_deck.js`。
// 完整规则： docs/ppt-guide.vi.md
// 安装： cd <deck-dir> && npm install pptxgenjs
// ============================================================
...
const HEAD = "Lato", BODY = "Lato";          // 正文用 sans；公式在外部用 STIX 渲染
...
// 在 box (bx,by,bw,bh) 内保持长宽比嵌入图像——读取 dims.json
...
// 真 bullet（不用 "•" 字符）；支持 {t, b:bold, lvl} 或 string
